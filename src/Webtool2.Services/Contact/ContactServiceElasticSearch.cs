namespace WebTool2.Services
{
    ...
    public class ContactServiceElasticSearch
    {
        public ContactServiceElasticSearch(ContactRepositoryElasticSearch repository)
        {
            this.Repository = repository;
        }

        private ContactRepositoryElasticSearch Repository { get; set; }
